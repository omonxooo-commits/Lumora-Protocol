...
const navItems = [
  ...
  { href: "/yield", label: "Yield & ROI", icon: TrendingUp },
  { href: "/governance", label: "Governance", icon: Vote },
  { href: "/staking", label: "Staking", icon: Coins },
  { href: "/market", label: "Secondary Market", icon: ShoppingCart },
];
    ...
    <aside className="flex w-64 flex-col border-r border-white/5 bg-gray-950">
      <div className="flex h-16 items-center gap-2.5 border-b border-white/5 px-6">
        ...
        <div>
          ...
          <p className="text-[10px] text-gray-500 uppercase tracking-wider">Investor Hub</p>
        </div>
      </div>
